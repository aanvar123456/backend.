# Generated by Django 4.2.5 on 2023-09-26 03:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Product', models.ForeignKey(on_delete=models.SET('Deleted'), to='sales_app.products')),
                ('Staff', models.ForeignKey(on_delete=models.SET('Deleted'), to='sales_app.staffs')),
            ],
            options={
                'db_table': 'Sales',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Staff', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sales_app.staffs')),
            ],
            options={
                'db_table': 'Returns',
            },
